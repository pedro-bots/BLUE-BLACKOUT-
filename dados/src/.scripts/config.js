...
const print = {
    ...
    header: () => {
        print.separator();
        console.log(`${colors.bold}💧Configurador Gênesis blue - Versão ${version}${colors.reset}`);
        console.log(`${colors.bold}👨‍💻 Criado por Pedro${colors.reset}`);
...
async function main() {
    ...
    print.message(`🎉 blue configurado e pronto para uso! Versão: ${version}`);
}
